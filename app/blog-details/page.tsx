...
export const metadata: Metadata = {
  title: "CoderzWeb | Professional Web Development Agency",
  description:
        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h2 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-gray-400 sm:text-4xl sm:leading-tight">
