        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h1 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-gray-400 sm:text-4xl sm:leading-tight">
                ...
                <div>
                  ...
                  <p className="mb-8 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    ...
                    <strong className="text-primary dark:text-gray-400">
                      {" "}
                      malesuada{" "}
                    </strong>
                  ...
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    ...
                    <span className="text-primary underline dark:text-gray-400">
                      {" "}
                  ...
                  <h3 className="font-xl mb-10 font-bold leading-tight text-black dark:text-gray-400 sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight">
            ...
            <div className="w-full px-4 lg:w-4/12">
              ...
              <div className="mb-10 rounded-sm bg-white shadow-three dark:bg-gray-dark dark:shadow-none">
                <h3 className="border-b border-body-color border-opacity-10 px-8 py-4 text-lg font-semibold text-black dark:border-white dark:border-opacity-10 dark:text-gray-400">
                  Related Posts
                </h3>
                <ul className="p-8">
