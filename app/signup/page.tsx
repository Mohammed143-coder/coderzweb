...
//                 <h3 className="mb-3 text-center text-2xl font-bold text-black dark:text-gray-400 sm:text-3xl">
//                   Create your account
//                 </h3>
...
//                     <label
//                       htmlFor="name"
//                       className="mb-3 block text-sm text-dark dark:text-gray-400"
//                     >
//                       {" "}
//                       Full Name{" "}
//                     </label>
